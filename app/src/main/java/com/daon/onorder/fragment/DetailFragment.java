...
public class DetailFragment extends Fragment {
    ...
    public void initViews(){
        ...
        if (name.contains("흑돼지") || name.contains("낙곱불") || name.contains("대창숙주") || name.contains("대창콩나물")){
        ...
        if (name.equals("흑돼지콩나물불고기") || name.equals("낙지흑돼지콩나물불고기") || name.equals("김치흑돼지콩나물불고기") || name.contains("전골") || name.contains("대창콩나물") || name.contains("낙곱불")){
...
//        GlideApp.with(getContext()).load(url).circleCrop().thumbnail(0.2f).into(menuImg);
        ...
        add_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (name.contains("흑돼지") || name.contains("낙곱불") || name.contains("대창콩나물")){
        ...
        opt10 = RootView.findViewById(R.id.opt10);
        opt10.setOnClickListener(new CheckBox.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (opt10.isChecked()){
                    AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
                    builder.setTitle("대창등뿍추가 수량을 선택하세요.");
                    builder.setCancelable(false);
                    String[] animals = {"0", "1", "2", "3", "4"};
                    builder.setItems(animals, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which) {
                                ...
                                case 1:
                                    ...
                                    priceText.setText("총 "+formattedStringPrice+ "원");
                                    str_opt10 = "1";
                                    opt10.setText("대창등뿍추가 "+str_opt10+"개");
                                    break;
                                case 2:
                                    price = String.valueOf(Integer.parseInt(price) + 20000);
                                    myFormatter = new DecimalFormat("###,###");
                                    formattedStringPrice = myFormatter.format(Integer.parseInt(price));
                                    priceText.setText("총 "+formattedStringPrice+ "원");
                                    str_opt10 = "2";
                                    ...
                                    break;
                                case 3:
                                    price = String.valueOf(Integer.parseInt(price) + 30000);
                                    myFormatter = new DecimalFormat("###,###");
                                    formattedStringPrice = myFormatter.format(Integer.parseInt(price));
                                    priceText.setText("총 "+formattedStringPrice+ "원");
                                    str_opt10 = "3";
                                    ...
                                    break;
                                case 4:
                                    price = String.valueOf(Integer.parseInt(price) + 40000);
                                    myFormatter = new DecimalFormat("###,###");
                                    formattedStringPrice = myFormatter.format(Integer.parseInt(price));
                                    priceText.setText("총 "+formattedStringPrice+ "원");
                                    str_opt10 = "4";
                    ...
                    if (str_opt10 != null) {
                        price = String.valueOf(Integer.parseInt(price) - (10000 * Integer.parseInt(str_opt10)));
                        DecimalFormat myFormatter = new DecimalFormat("###,###");
                        String formattedStringPrice = myFormatter.format(Integer.parseInt(price));
                        priceText.setText("총 " + formattedStringPrice + "원");
                        opt10.setText("대창듬뿍추가 (+10,000원)");
                    }
                }
            }
        });
        opt11 = RootView.findViewById(R.id.opt11);
        opt11.setOnClickListener(new CheckBox.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (opt11.isChecked()){
                    AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which) {
                                ...
                                case 1:
                                    ...
                                    priceText.setText("총 "+formattedStringPrice+ "원");
                                    str_opt11 = "1";
                                    opt11.setText("낚지사리추가 "+str_opt11+"개");
                                    break;
                                case 2:
                                    price = String.valueOf(Integer.parseInt(price) + 12000);
                                    myFormatter = new DecimalFormat("###,###");
                                    formattedStringPrice = myFormatter.format(Integer.parseInt(price));
                                    priceText.setText("총 "+formattedStringPrice+ "원");
                                    str_opt11 = "2";
                                    ...
                                    break;
                                case 3:
                                    price = String.valueOf(Integer.parseInt(price) + 18000);
                                    myFormatter = new DecimalFormat("###,###");
                                    formattedStringPrice = myFormatter.format(Integer.parseInt(price));
                                    priceText.setText("총 "+formattedStringPrice+ "원");
                                    str_opt11 = "3";
                                    ...
                                    break;
                                case 4:
                                    price = String.valueOf(Integer.parseInt(price) + 24000);
                                    myFormatter = new DecimalFormat("###,###");
                                    formattedStringPrice = myFormatter.format(Integer.parseInt(price));
                                    priceText.setText("총 "+formattedStringPrice+ "원");
                                    str_opt11 = "4";
                    ...
                    if (str_opt11 != null) {
                        price = String.valueOf(Integer.parseInt(price) - (6000 * Integer.parseInt(str_opt11)));
                        DecimalFormat myFormatter = new DecimalFormat("###,###");
                        String formattedStringPrice = myFormatter.format(Integer.parseInt(price));
                        priceText.setText("총 " + formattedStringPrice + "원");
                        opt11.setText("낚지사리추가 (+6,000원)");
                    }
                }
            }
        });
    ...
    public void sendOpt(){
        ...
        if (opt10.isChecked()){
            String price = String.valueOf(Integer.parseInt(str_opt10)* 10000);
            for (int i = 0; i < Integer.parseInt(str_opt10); i++) {

                ((MenuActivity) getActivity()).callItem("대창듬뿍추가", "10000", url, code, "1");
            }
        }
        if (opt11.isChecked()){
            String price = String.valueOf(Integer.parseInt(str_opt11)* 6000);
            for (int i = 0; i < Integer.parseInt(str_opt11); i++) {

                ((MenuActivity) getActivity()).callItem("낚지사리추가", "6000", url, code, "1");
            }
        }
    }
}